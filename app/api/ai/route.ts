...
- إلا كنت محتاج تستشهد بكلمة أو عبارة فرنسية داخل الشرح، دير حواليها علامات هكا: «الكلمة الفرنسية». هاد الطريقة كتخلي القراءة واضحة و ما كتخلطش بين الحروف العربية و اللاتينية.
...
مثال على شرح مزيان:
"استعملتي كلمة «poil» اللي معناها الزغب، والصحيح هو «carte» لأنك كتهضر على البطاقة البنكية."
