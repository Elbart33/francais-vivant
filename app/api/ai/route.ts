...
Dans cette explication, entoure le mot ou l'expression clé (celui qui pose problème ou qui change) avec **deux astérisques**, comme ceci : "Tu confonds **le/la** — pense au genre du mot." Un seul mot-clé entouré par explication, pas plus.
...
- إلا كانت الكلمة المميزة هادي بالفرنسية أو بحروف لاتينية، خاصك تجمع بين النجمتين و علامات « » بهاد الشكل بالضبط: **«mot»** (النجمتين برا، و« » مباشرة حوالين الكلمة). هادشي كيخلي الكلمة الفرنسية واضحة و معزولة وسط النص العربي.
