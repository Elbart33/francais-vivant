...
const SYSTEM_PROMPT_GROQ_DARIJA = `أنت مدرب دارجة مغربية و فرونسي. خدمتك هي تصحيح الجمل ديال الناس اللي كيتعلمو الفرنسية.
    ...
    try {
      if (provider === "gemini") {
        try {
          ...
          const params = { system: SYSTEM_PROMPT_GROQ_DARIJA, user: userPrompt };
